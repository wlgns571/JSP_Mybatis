...
public class MemberVO {
	...
	private String boCatJobNm; /* 카테고리 이름 */
	private String boCatHobNm; /* 카테고리 이름 */
	...
	public String getBoCatJobNm() {
		return boCatJobNm;
	}

	public void setBoCatJobNm(String boCatJobNm) {
		this.boCatJobNm = boCatJobNm;
	}

	public String getBoCatHobNm() {
		return boCatHobNm;
	}

	public void setBoCatHobNm(String boCatHobNm) {
		this.boCatHobNm = boCatHobNm;
	}
